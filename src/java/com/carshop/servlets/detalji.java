 ...
 * @author Ognjen
 */
@WebServlet(name = "detalji", urlPatterns = {"/detalji"})
public class detalji extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Auto a = (Auto) session.getNamedQuery("Auto.findById").setInteger("id", Integer.parseInt(request.getParameter("id"))).uniqueResult();
        tx.commit();
        session.close();
